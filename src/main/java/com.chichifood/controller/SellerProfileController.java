...
public class SellerProfileController {
    ...
    public void seedSampleData() {
        NetworkService.getProfile(apiResponse -> {
            ...
            String fullName = json.has("full_name") ? json.get("full_name").getAsString() : "";
            ...
            String bankName = json.has("bank_name") ? json.get("bank_name").getAsString() : "";
            String accountNumber = json.has("account_number") ? json.get("account_number").getAsString() : "";
